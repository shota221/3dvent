...
/***/ "./resources/js/form/_form_org_regist.class.js":
/*!*****************************************************!*\
  !*** ./resources/js/form/_form_org_regist.class.js ***!
  \*****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
(function (factory) {
  ...
  var FormOrgRegist; //BaseFormClassを継承したFormOrgRegistクラスを返す

  return FormOrgRegist = ClassUtils.Extend(BaseFormClass, function FormOrgRegist($elm) {
    //コンストラクタ定義
    //コールメソッドによりオブジェクトのコンストラクタを連鎖
    FormOrgRegist.prototype.__super__.constructor.call(this, $elm); //この親クラスのコンストラクタにより$formが$elmと紐づく
...
(function (factory) {
  module.exports = factory(jQuery, __webpack_require__(/*! ./_form_org_regist.class */ "./resources/js/form/_form_org_regist.class.js"));
})(function ($, FormOrgRegistClass) {
  'use strict';

  var FormOrgRegist = new FormOrgRegistClass($('form#form-content'));
  subscribeEvents();
  FormOrgRegist.build();

  function subscribeEvents() {
    FormOrgRegist.on('submit', function (submitDeferred, formData, action, method) {
      $.ext.ajax({
        ajaxName: 'registOrg',
        type: method,
        url: action,
        ...
        success: function success(parsedResult) {
          $.ext.notify.success(i18n('message.applied')); //非同期処理完了

          submitDeferred.resolve();
        },
        error: function error(errors) {
          FormOrgRegist.handleFieldErrors(errors); //非同期処理異常終了
