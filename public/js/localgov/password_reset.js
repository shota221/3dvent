...
/***/ "./resources/js/localgov/password_reset/_form_password_reset.class.js":
/*!****************************************************************************!*\
  !*** ./resources/js/localgov/password_reset/_form_password_reset.class.js ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ "./resources/js/localgov/password_reset/index.js":
/*!*******************************************************!*\
  !*** ./resources/js/localgov/password_reset/index.js ***!
  \*******************************************************/
/*! no static exports found */
...
(function (factory) {
  module.exports = factory(jQuery, i18n, __webpack_require__(/*! ./_form_password_reset.class */ "./resources/js/localgov/password_reset/_form_password_reset.class.js"));
})(function ($, i18n, FormRegistClass) {
  'use strict';

  var FormRegist = new FormRegistClass($('form')).build();
  ;
  subscribeEvents();
  /**
   * イベントリスナー
  ...
  function subscribeEvents() {
    FormRegist.on('submit', submit).on('cancel', function (cancelDeferred) {
      location.reload();
    });
  }
  /**
...
/***/ 8:
/*!*************************************************************!*\
  !*** multi ./resources/js/localgov/password_reset/index.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /mnt/workspace/resources/js/localgov/password_reset/index.js */"./resources/js/localgov/password_reset/index.js");
