...
/***/ "./resources/js/common/form_auth.class.js":
/*!************************************************!*\
  !*** ./resources/js/common/form_auth.class.js ***!
  \************************************************/
...
/***/ "./resources/js/localgov/auth/_form_apply_password_reset.class.js":
/*!************************************************************************!*\
  !*** ./resources/js/localgov/auth/_form_apply_password_reset.class.js ***!
  \************************************************************************/
/*! no static exports found */
...
/***/ "./resources/js/localgov/auth/index.js":
/*!*********************************************!*\
  !*** ./resources/js/localgov/auth/index.js ***!
  \*********************************************/
/*! no static exports found */
...
(function (factory) {
  module.exports = factory(jQuery, i18n, __webpack_require__(/*! ../../common/form_auth.class */ "./resources/js/common/form_auth.class.js"), __webpack_require__(/*! ./_form_apply_password_reset.class */ "./resources/js/localgov/auth/_form_apply_password_reset.class.js"), __webpack_require__(/*! ../../components/modal.class */ "./resources/js/components/modal.class.js"));
})(function ($, i18n, FormAuthClass, FormApplyPasswordResetClass, ModalClass) {
  'use strict';

  var FormAuth = new FormAuthClass($('form')),
  ...
  subscribeEvents(); // login form build

  FormAuth.build(); // regist form build

  FormApplyPasswordReset.build(); // modal build
  ...
  function subscribeEvents() {
    FormAuth.on('submit', function (submitDeferred, formData, action, method) {
      //
      $.ext.ajax({
        ajaxName: 'auth',
        type: method,
    ...
    $applyPasswordResetBtn.on('click', function () {
      ModalApplyPasswordReset.open();
    });
    FormApplyPasswordReset.on('submit', function (submitDeferred, formData, action, method) {
      //
      $.ext.ajax({
...
/***/ 6:
/*!***************************************************!*\
  !*** multi ./resources/js/localgov/auth/index.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /mnt/workspace/resources/js/localgov/auth/index.js */"./resources/js/localgov/auth/index.js");
