...
return [
    ...
    */
    ...
    'account_or_password_incorrect'       => 'Account Name or passcord is incorrect.',
    ...
    'code_not_found'                      => "That group code doesn't exist.",
    'csv_duplicated_patient_code'         => 'File loading canceled. Patient ID :patient_code has already been used by the specified group. Please rewrite the patient number.',
    ...
    'duplicated_patient_code'             => 'This Patient ID has already been registered with your organization.',
    'duplicated_patient_id'               => 'This ID has already been registered.',
    'duplicated_registration'             => "It's already registered.",
    'duplicated_user_name'                => 'This user name has already been registered with your group.',
    ...
    'organization_mismatch'               => 'Inconsistent group information.',
    'password_confirmed'                  => 'The passcord confirmation does not match.',
    'required_for_principal_investigator' => 'An Email Address is required for Physician (Group Chief).',
    'required_password_confirmation'      => 'The Passcode(re-enter for confirmation).',
    'required_password'                   => 'The Passcord field is required.',
    'unauthenticated'                     => 'Authentication Error.',
    'user_token_required'                 => 'User token is required.',
    'ventilator_value_exists_yet'         => 'Before deleting the MicroVent device, delete all the device settings and measurement data associated with the target device.', 
    ...
    */
    ...
    'attributes' => [
        ...
        'adverse_event_contents'         => 'The Adverse Effect Name',
        'adverse_event_flg'              => 'Any Adverse Effect due to MicroVent®V3',
        'age'                            => 'Age(years)',
        'air_flow'                       => 'Air Flow Rate',
        'airway_pressure'                => 'Pressure Dial Setting',
        'authority'                      => 'Authority',
        'bug_name'                       => 'Name of Device Failure',
        'code'                           => 'Group Code',
        ...
        'name'                           => 'Account Name',
        'national'                       => 'Countory Name',
        'o2_flow'                        => 'Oxygen Flow Rate',
        'opt_out_flg'                    => 'Remove Patient Data（Opt-out）',
        'org_authority_type'             => "Job Privilege",
        'organization_code'              => 'Group code',
        'organization_name'              => 'Group name',
        'other_disease_name_1'           => 'Co-existing disease1',
        'other_disease_name_2'           => 'Co-existing disease2',
        ...
        'user_name'                      => 'User Name',
        'vent_disease_name'              => 'Primary disease name for using MicroVent®V3',
        'ventilator_value_scan_interval' => 'Sustained Setting Value over 15 Minutes',
