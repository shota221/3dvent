    ...
    <div class="container-fluid">
        ...
        <div class="card card-default color-pallete-box">
            <div class="card-header">
                ...
                <form action="{{ route('admin.sv_user.detail.confirmation',['id' => $user->id]) }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <h4>データ閲覧者詳細・変更</h4>
                        <p>
                    ...
                    <div class="form-group">
                        <label for="team">所属<span class="required"></span></label>
                        <input class="form-control" type="text" name="team" id="team" placeholder=''
                            required value="{{$user->team}}">
                    ...
                    <div class="form-group">
                    <a class="btn btn-small btn-secondary btn-block" href="{{route('admin.sv_user.index')}}">データ閲覧者一覧に戻る</a>
                    </div>
                    </div>
                </form>
        </div>
