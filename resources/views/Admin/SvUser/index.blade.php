        ...
        <div class="card-body">
            <div class="row d-flex justify-content-between my-3">
                ...
                <div class="row">
                    ...
                    <div class="ml-3 mr-3">
                        <a href="{{ route('admin.sv_user.registration') }}" class="btn btn-primary float-right">新規登録</a>
                    </div>    
                </div>
            </div>
                <table class="table table-striped">
                    ...
                    @foreach ($users->paginator as $user)
                        <tr>
                            <td> <a href="{{ route('admin.sv_user.detail', ['id'=>$user->id]) }}"
    ...
    <div class="modal-dialog" style="margin-top: 10%; width: 50%;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: auto;">
                <form action="{{  route('admin.sv_user.index')  }}" method="GET" id="search-form">
                    @csrf
