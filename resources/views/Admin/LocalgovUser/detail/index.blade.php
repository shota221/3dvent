...
@section('content')
    <div class="container-fluid">
        ...
        <div class="alert alert-warning alert-dismissible">
            ...
            既存ユーザーに自治体ユーザー権限を追加したい場合は、管理者にお問い合わせください。
          </div>
        @endisset
        <div class="card card-default color-pallete-box">
            <div class="card-header">
                ...
                <form action="{{ route('admin.localgov_user.detail.confirmation',['id' => $user->id]) }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <h4>自治体ユーザー詳細・変更</h4>
                        <p>
                    ...
                    <div class="form-group">
                        <label for="localgov_code">市区町村コード<span class="required"></span></label>
                        <input class="form-control" type="text" name="localgov_code" id="localgov_code" placeholder=''
                            required value="{{$user->localgov_code}}">
                    ...
                    <div class="form-group">
                    <a class="btn btn-small btn-secondary btn-block" href="{{route('admin.localgov_user.index')}}">自治体ユーザー一覧に戻る</a>
                    </div>
                    </div>
                </form>
        </div>
