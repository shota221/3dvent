        ...
        <div class="card-body">
            <div class="row d-flex justify-content-between my-3">
                ...
                <div class="row">
                    ...
                    <div class="ml-3 mr-3">
                        <a href="{{ route('admin.localgov_user.registration') }}" class="btn btn-primary float-right">新規登録</a>
                    </div>    
                </div>
            </div>
                ...
                <table class="table table-striped">
                    ...
                    @foreach ($users->paginator as $user)
                        <tr>
                            <td> <a href="{{ route('admin.localgov_user.detail',['id'=>$user->id]) }}"
                                    class="btn btn-primary">詳細</a>&nbsp;
                            </td>
                            <td class="align-middle">{{ $user->localgov_name }}</td>
    ...
    <div class="modal-dialog" style="margin-top: 10%; width: 50%;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: auto;">
                <form action="{{ route('admin.localgov_user.index') }}" method="GET" id="search-form">
                    @csrf
                    <div class="form-group">
                        <label for="input-localgov">自治体名/市区町村コード</label>
                        <input class="form-control" type="text" name="localgov" id="input-localgov" placeholder="すべて">
                    </div>
                    <div class="form-group">
