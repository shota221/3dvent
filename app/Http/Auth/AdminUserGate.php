...
class AdminUserGate
{
    ...
    const
         ...
         */
        //00100000000000000
        CHAT_OPERATABLE = 16384
        ;

    /**
     * admin（◯：全データ、△：研究参加施設のデータ、✕：権限なし）
     */
    //　　　　　　　　　　　呼吸器データ(閲覧)　呼吸器データ(編集) 機器観察研究データ(閲覧)　機器観察研究データ(編集) 患者観察研究データ(閲覧) 患者観察研究データ(編集)　組織データ(閲覧)　組織データ（編集）チャットサポート 　 権限            値
    //プロジェクト運営者　　◯                   ◯               ◯                       ◯                   ◯                       ◯                      ◯               ◯               ◯　　　　　　　111111111111111  32767
    //データマネージャー　　◯                   ◯               ◯                       ◯                   ◯                       ◯                      ◯               ◯               ✕　　　　　　　011111111111111  16383
    //データモニター　　　　◯                   ✕               ◯                       ✕                   ◯                       ✕                      ◯               ✕               ✕　　　　　　　001001100110011  4915
    //医師（全体研究代表者）◯                   ✕               ◯                       ✕                   △                       ✕                      ◯               ✕               ✕　　　　　　　001000100110011  4403
    //企業管理ユーザ　　　　◯                   ✕               ✕                       ✕                   ✕                       ✕                      ◯               ✕             　✕　　　　　　  001000000000011  4099
    ...
    public static function define()
    {
        ...
        // チャットサポート
        Gate::define('chat_operatable', function ($user) {
            return 0 < ($user->authority & self::CHAT_OPERATABLE);
        });
    }
