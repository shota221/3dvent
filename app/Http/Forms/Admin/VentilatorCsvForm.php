...
class VentilatorCsvForm extends BaseForm
{
    ...
    {
        $this->org_ventialtor_id = intval($input['ventialtor_id']);
        ...
        $this->patient_value_registered_at = isset($input['patient_value_registered_at']) ? Support\DateUtil::parseToDatetime($input['patient_value_registered_at']) : null;
        ...
        $this->discontinuation_at = isset($input['discontinuation_at']) ? Support\DateUtil::parseToDatetime($input['discontinuation_at']) : null;
        ...
        $this->ventilator_value_registered_at = isset($input['ventilator_value_registered_at']) ? Support\DateUtil::parseToDatetime($input['ventilator_value_registered_at']) : null;
        ...
        $this->fixed_at = isset($input['fixed_at']) ? Support\DateUtil::parseToDatetime($input['fixed_at']) : null;
        $this->confirmed_flg = isset($input['confirmed_flg']) ? intval($input['confirmed_flg']) : null;
        $this->confirmed_at = isset($input['confirmed_at']) ? Support\DateUtil::parseToDatetime($input['confirmed_at']) : null;
    }
}
